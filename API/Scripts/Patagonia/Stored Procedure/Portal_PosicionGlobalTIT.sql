if OBJECT_ID('dbo.PosicionGlobalTIT') is not null
begin
	drop procedure dbo.PosicionGlobalTIT
end
go
...
begin
	...
	select ltrim(rtrim(cl.clie_nrodoc)) + ' - ' + ltrim(rtrim(cl.clie_nombreafip)) 'Cliente', cc.ccus_numero 'Cuenta',@_fecha 'Fecha'
